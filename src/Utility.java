...
class Utility {
    ...
    // Default sinking value every round
    public static int defaultSink = 1;
    ...
    public static final Scenario SCENARIO_ONE = new Scenario(
        ...
        List.of(new Update(APPROVAL, TRANSLATE, defaultChangeOne), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static final Scenario SCENARIO_TWO = new Scenario(
        ...
        List.of(new Update(APPROVAL, TRANSLATE, defaultChangeTwo), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static final Scenario SCENARIO_THREE = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeThree), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static final Scenario SCENARIO_FOUR = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeFour), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static final Scenario SCENARIO_FIVE = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeFive), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static final Scenario SCENARIO_SIX = new Scenario(
        ...
        List.of(new Update(POPULATION, TRANSLATE, defaultChangeSix), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static final Scenario SCENARIO_SEVEN = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeSeven), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    //Variables for policy 1:
    public static int floodProtectionEightOne = 10;
    public static int moneyChangeEightOne = -2500;
    ...
    public static final Scenario SCENARIO_EIGHT = new Scenario(
        ...
        List.of(new Update(FLOOD_PROTECTION_INFRASTRUCTURE, TRANSLATE, defaultChangeEight), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
        new Policy("Restrict the construction of new urban buidlings upgrade the old ones such that they are able to withstand floods. This will cost you $5000 over 2 turns", "As a result of your efforts, FLOOD PROTECTION INCREASES over 2 turns", new FutureUpdate(new Update(MONEY, TRANSLATE, moneyChangeEightOne), 1), new FutureUpdate(new Update(MONEY, TRANSLATE, moneyChangeEightOne), 2), new FutureUpdate(new Update(FLOOD_PROTECTION_INFRASTRUCTURE, TRANSLATE, floodProtectionEightOne), 1), new FutureUpdate(new Update(FLOOD_PROTECTION_INFRASTRUCTURE, TRANSLATE, floodProtectionEightOne), 2)),
    ...
    public static final Scenario SCENARIO_NINE = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeNine), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static final Scenario SCENARIO_TEN = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeTen), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
    ...
    public static int moneyChangeElevenThree = -6000;
    ...
    public static final Scenario SCENARIO_ELEVEN = new Scenario(
        ...
        List.of(new Update(POPULATION, TRANSLATE, defaultChangeElevenOne), new Update(FLOOD_PROTECTION_INFRASTRUCTURE, TRANSLATE, defaultChangeElevenTwo), new Update(LAND_SUBSIDENCE, TRANSLATE, defaultSink)),
        new Policy("Relocate those living in areas that have major risks of flooding. This will cost you $2000.", "Your swift action has impressed your people and APPROVAL increaases.", new Update(APPROVAL, TRANSLATE, approvalChangeElevenOne), new Update(MONEY, TRANSLATE, moneyChangeElevenOne)),
        new Policy("Build taller seawalls to protect those living in areas that have major risks of flooding. This will cost you $2000.", "Your swift action has impressed your people and APPROVAL increases. FLOOD PROTECTION increases.", new Update(APPROVAL, TRANSLATE, approvalChangeElevenTwo), new Update(MONEY, TRANSLATE, moneyChangeElevenTwo),  new Update(FLOOD_PROTECTION_INFRASTRUCTURE, TRANSLATE, floodProtectionElevenTwo)),
        new Policy("Build a Jakarta Barrage to act as a dam. This will cost you $6000.", "APPROVAL and FLOOD PROTECTION increases.", new Update(MONEY, TRANSLATE, moneyChangeElevenThree), new Update(APPROVAL, TRANSLATE, approvalChangeElevenThree), new Update(FLOOD_PROTECTION_INFRASTRUCTURE, TRANSLATE, floodProtectionElevenThree)),
