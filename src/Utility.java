...
class Utility {
    ...
    public static final Scenario SCENARIO_ONE = new Scenario(
        ...
        List.of(new Update(APPROVAL, TRANSLATE, defaultChangeOne)),
    ...
    public static final Scenario SCENARIO_TWO = new Scenario(
        ...
        List.of(new Update(APPROVAL, TRANSLATE, defaultChangeTwo)),
    ...
    public static final Scenario SCENARIO_THREE = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeThree)),
    ...
    public static final Scenario SCENARIO_FOUR = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeFour)),
    ...
    public static final Scenario SCENARIO_FIVE = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeFive)),
    ...
    public static final Scenario SCENARIO_SIX = new Scenario(
        ...
        List.of(new Update(POPULATION, TRANSLATE, defaultChangeSix)),
    ...
    public static final Scenario SCENARIO_SEVEN = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeSeven)),
    ...
    public static final Scenario SCENARIO_EIGHT = new Scenario(
        ...
        List.of(new Update(FLOOD_PROTECTION_INFRASTRUCTURE, TRANSLATE, defaultChangeEight)),
    ...
    public static final Scenario SCENARIO_NINE = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeNine)),
    ...
    public static final Scenario SCENARIO_TEN = new Scenario(
        ...
        List.of(new Update(MONEY, TRANSLATE, defaultChangeTen)),
    ...
    public static final Scenario SCENARIO_ELEVEN = new Scenario(
        ...
        List.of(new Update(POPULATION, TRANSLATE, defaultChangeElevenOne)),
